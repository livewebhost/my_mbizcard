const database = {
  ...
  profile: {
    ...
    about: {
      ...
      aboutusshort: "मैं एक creative video editor और digital content creator हूँ, जो business promotions के लिए engaging Instagram reels बनाती हूँ। चाहे आपका brand नया हो या established — मैं आपके products और services को short, impactful reels के ज़रिए audience तक पहुँचाने में मदद करती हूँ। हर reel को unique concept, trending sound और smart editing से बनाया जाता है ताकि आपका business online grow करे और लोगों का ध्यान खींचे। अगर आप भी अपने business, brand या service के लिए professional reel बनवाना चाहते हैं — तो आज ही contact करें!",
    }
  },
